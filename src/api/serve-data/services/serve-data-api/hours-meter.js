...
module.exports = {
    getHoursMeter: async (searchComponent, authentication) => {
        try {
            let {
                page,
                size,
            ...
            for (let i = 0; i < arrayResult.length; i++) {
                ...
                let tingkatKehadiranQuery =
                    `
                    select * from (select uu.id as user_id, tk.id as hours_meter_id, tk.total_hm, tk.nilai_mor, tk.nilai_akhir, tk.bulan, tk.tahun, tk.created_at, tk.updated_at, uu2.name as created_by, uu3.name as updated_by from hours_meters tk 
                ...
                let objResult = {
                    ...
                    total_hm: newResult[0][0]?.total_hm ?? 0,
