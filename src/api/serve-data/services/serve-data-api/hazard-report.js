...
module.exports = {
    getHazardReport: async (searchComponent, authentication) => {
        try {
            let {
                page,
                size,
            ...
            for (let i = 0; i < arrayResult.length; i++) {
                ...
                let tingkatKehadiranQuery =
                    `
                    select * from (select uu.id as user_id, tk.id as hazard_report_id, tk.hasil, tk.nilai_mor, tk.nilai_akhir, tk.bulan, tk.tahun, tk.created_at, tk.updated_at, uu2.name as created_by, uu3.name as updated_by from hazard_reports tk 
