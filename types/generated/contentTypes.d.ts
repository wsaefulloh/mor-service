...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    role_mor: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::role-mor.role-mor'
    >;
    password_mor: Attribute.String;
    nrp: Attribute.String;
    jabatan: Attribute.String;
    versatility: Attribute.String;
    grade: Attribute.String;
    name: Attribute.String;
    tingkat_kehadirans: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiDisiplinKerjaDisiplinKerja extends Schema.CollectionType {
  ...
  info: {
    singularName: 'disiplin-kerja';
    pluralName: 'disiplin-kerjas';
    displayName: 'Disiplin Kerja';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    user_name: Attribute.Relation<
      'api::disiplin-kerja.disiplin-kerja',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiHazardReportHazardReport extends Schema.CollectionType {
  collectionName: 'hazard_reports';
  info: {
    singularName: 'hazard-report';
    pluralName: 'hazard-reports';
  ...
  attributes: {
    user_name: Attribute.Relation<
      'api::hazard-report.hazard-report',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    bulan: Attribute.String;
...
export interface ApiHoursMeterHoursMeter extends Schema.CollectionType {
  collectionName: 'hours_meters';
  info: {
    singularName: 'hours-meter';
    pluralName: 'hours-meters';
    displayName: 'Hours Meter';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiKeseringanInsidenKeseringanInsiden
  extends Schema.CollectionType {
  collectionName: 'keseringan_insidens';
  info: {
    singularName: 'keseringan-insiden';
    pluralName: 'keseringan-insidens';
    displayName: 'Keseringan Insiden';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiProductivityIndividuProductivityIndividu
  extends Schema.CollectionType {
  collectionName: 'productivity_individus';
  info: {
    singularName: 'productivity-individu';
    pluralName: 'productivity-individus';
    displayName: 'Productivity Individu';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    user_name: Attribute.Relation<
      'api::productivity-individu.productivity-individu',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    nilai_mor: Attribute.Decimal;
...
export interface ApiRoleMorRoleMor extends Schema.CollectionType {
  collectionName: 'role_mors';
  info: {
    singularName: 'role-mor';
    pluralName: 'role-mors';
    displayName: 'Role MOR';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiTingkatKehadiranTingkatKehadiran
  ...
  info: {
    singularName: 'tingkat-kehadiran';
    pluralName: 'tingkat-kehadirans';
    displayName: 'Tingkat Kehadiran';
    description: '';
  };
  options: {
    draftAndPublish: false;
